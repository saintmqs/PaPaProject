...
//            self.countLabel.text = [NSString stringWithFormat:@"%ld", DARecycledTileViewCount];
...
{
    return [NSString stringWithFormat:@"Recycled index: %ld, %@", self.index, [super description]];
}
