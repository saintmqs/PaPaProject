...
- (void)initialization
{
    self.dotViewClass           = [PPAnimatedDotView class];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (touch.view != self) {
        ...
        if ([self.delegate respondsToSelector:@selector(PPPageControl:didSelectPageAtIndex:)]) {
            [self.delegate PPPageControl:self didSelectPageAtIndex:index];
        }
    }
}
...
{
    if (self.dotViewClass) {
        PPAbstractDotView *abstractDotView = (PPAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            NSLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [PPAbstractDotView class]);
        }
